    ...
    >
      ...
      >
        ...
        <div className="flex items-center space-x-6">
          ...
          />
          <div>
            <h1 className="text-white text-3xl font-bold">Shreya Ghoshal</h1>
        ...
        <p className="text-gray-300 mt-8 leading-relaxed text-md">
          Shreya Ghoshal is a soulful playback singer whose music has touched millions. Known for her
          emotional ballads and soothing voice, Shreya has become the voice of a generation. With
          global recognition and an enormous fanbase, her songs continue to dominate the charts and
          hearts alike.
        </p>
